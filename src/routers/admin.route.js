...
router
    ...
    .patch("/forget-password",validate(adminValidation.forgetPassword),adminController.forgetPassword)
    .patch("/confirm-otp",validate(AdminValidation.confirmOTP), adminController.confirmOtp)
    .patch("/confirm-password",validate(adminValidation.confirmPassword),adminController.confirmPassword)
